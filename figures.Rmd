...
```{r}
# Figure 1A ----------
freqsdf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 1", skip = 1)
...
freqsdf_quaterly  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 2", skip = 1)
dunnpdf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 3", skip = 1)
...
# Figure 1C ----------
freqsdf_traj  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 4", skip = 1)
...
# Figure 1D ----------
gainlossdf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 5", skip = 1)
...
# Figure 1E ----------
aachfreqsdf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 7", skip = 1)
cutoff_th = 0.05
...
# Figure 1F ----------
aaprefsdf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 6", skip = 1)
...
# Figure 1H ----------
gainlossdf_aach  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 8", skip = 1)
...
cairo_pdf(file = "plts_ready_pdf/figure_1.pdf", width = conv_unit(18, "cm", "inch"), height = conv_unit(18.5, "cm", "inch"))
plt_fig1
dev.off()
```
...
```{r}
# Table 1 ----------
genotypesdf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 9", skip = 1)
genotypesdf %<>% 
...
freqsdf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 1", skip = 1)
frequent_ncs <- freqsdf$`Bar color`[freqsdf$`Relative frequency` > 0.1] %>% set_names(freqsdf$`Nucleotide change`[freqsdf$`Relative frequency` > 0.1])
gainsdf_traj  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 10", skip = 1)
...
# Figure 2D ----------
modeldf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 11", skip = 1)
...
# Figure 2E ----------
bgainreddf  <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 12", skip = 1)
...
```{r}
# Figure 3A ----------
bindingdf <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 13", skip = 1)
...
# Figure 3B ----------
tcelldf <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 14", skip = 1)
...
bloomdf <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 15", skip = 1)
...
gainlossdf_bloom <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 16", skip = 1)
...
gainlossdf_iedb <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 17", skip = 1)
plt_supplfig2a <- CreateGainlossPlots(gainlossdf_iedb, facet_row_n = 1, pvalpos = 70) +
  xlab("") + ylab("Number of mutations")

# Supplementary Figure 2B ----------
gainlossdf_rubella <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 18", skip = 1)
...
```{r}
netgainsdf <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 23", skip = 1)
...
aachfreqsdf_GU <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 24", skip = 1)
...
hydrophchdf_GU <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 25", skip = 1)
...
gainlossdf_GU <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 26", skip = 1)
...
```{r}
bgainsdf_alleles <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 27", skip = 1)
bgainsdf_alleles %<>%
...
```{r}
bgainsdf_invitro_subj <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 28", skip = 1)
...
```{r}
# loading data -----------
fitnessdf <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 29", skip = 1)
...
gainlossdf_figr1 <- readxl::read_excel("supplementary_data_tables/Source_Data.xlsx", sheet = "Supplementary Data Table 30", skip = 1)
